...
public class TextChunk
{
    ...
    public string ChunkText
    {
        get
        {
            if (field == null)
            {
                ...
                field = GetTokenIntervalText(Document.TokenizedText, TokenInterval);
            }
            return field;
        }
    }
    ...
    private string GetTokenIntervalText(TokenizedText tokenizedText, TokenInterval interval)
    {
        ...
        var endIdx = interval.EndIndex - 1;
        ...
        var startPos = startToken.CharInterval.StartPos ?? 0;
        var endPos = endToken.CharInterval.EndPos ?? 0;
